...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn round_transition_on_initialize(x: u32, y: u32, ) -> Weight {
		(0 as Weight)
			...
			.saturating_add((45_389_000 as Weight).saturating_mul(x as Weight))
			// Standard Error: 2_000
			.saturating_add((256_000 as Weight).saturating_mul(y as Weight))
